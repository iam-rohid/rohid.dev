...
import dbmlLivePreview from "@/assets/blog/generate-database-diagram-from-drizzle-schema/dbml-live-preview.gif";
import dbmlEntityRelationshipDiagramsVisualizer from "@/assets/blog/generate-database-diagram-from-drizzle-schema/dbml-entity-relationship-diagrams-visualizer.gif";
